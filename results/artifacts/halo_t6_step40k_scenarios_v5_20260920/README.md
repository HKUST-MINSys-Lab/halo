# T6, step 40k — deployment scenarios
...
Seven scenarios at 8 seconds, `k = 0, 1, 4, 8, 32`; manifests identical to the released-baseline
scenario artifact on all 737 shared cells. T6 beats v3 on the new-domain cell at every k (10.5
against 6.6 at k=0, the first time this cell has exceeded its 10.0 chance level), on device set and
missing modality at every k, and trails it on cross placement at k >= 1.
