...
| halo:rung1-trained-last | 42.9 | 48.3 | 49.2 | 49.3 | 48.9 | 47.9 | 47.9 | -0.4 |
| halo:rung1-trained-last-T30 | 42.9 | 48.8 | 49.4 | 49.5 | 49.1 | 48.0 | 48.1 | -0.7 |
...
| halo:rung1-trained-last | 42.9 | 48.0 | 48.2 | 49.3 | 48.6 | 47.7 | 47.9 | -0.1 |
| halo:rung1-trained-last-T30 | 42.9 | 48.2 | 48.5 | 49.5 | 48.7 | 48.1 | 48.3 | 0.1 |
...
|---|---:|---:|---:|---:|---:|
| halo | 11 | 3 | 0 | 3 | 1 |
| halo:rung1-trained-last | 11 | 5 | 0 | 2 | 1 |
| halo:rung1-trained-last-T30 | 11 | 5 | 0 | 2 | 1 |
| harnet10 | 11 | 1 | 3 | 0 | 0 |
| harnet5 | 11 | 2 | 3 | 0 | 0 |
...
| halo:rung1-trained-last | 33.0 → 34.6 → 37.2 | 65.3 → 68.5 → 67.5 | 41.6 → 47.3 → 46.4 | 58.0 → 63.1 → 67.2 | 32.1 → 37.0 → 38.6 | 27.6 → 39.3 → 30.7 |
| halo:rung1-trained-last-T30 | 33.0 → 34.6 → 37.5 | 65.3 → 68.4 → 67.7 | 41.6 → 47.4 → 46.9 | 58.0 → 63.4 → 67.4 | 32.1 → 37.3 → 38.6 | 27.6 → 41.6 → 30.3 |
...
| dataset / stream | halo | halo:rung1-trained-last | halo:rung1-trained-last-T30 | harnet10 | harnet5 | limubert_x | normwear | unimts |
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| inclusivehar / phone_waist | 43.6 → 46.6 | 34.6 → 37.2 | 34.6 → 37.5 | 27.9 → 26.1 | 24.6 → 25.9 | 24.0 → 22.4 | 19.1 → 20.5 | 30.1 → 29.3 |
| motionsense / phone_front_pocket | 71.8 → 71.3 | 68.5 → 67.5 | 68.4 → 67.7 | 39.5 → 39.5 | 39.2 → 39.2 | 38.4 → 38.1 | 28.0 → 29.9 | 44.8 → 38.5 |
| realworld / phone_forearm | 36.9 → 41.1 | 42.5 → 43.6 | 42.6 → 43.4 | 28.0 → 27.3 | 27.5 → 27.3 | 26.4 → 31.4 | 11.0 → 12.7 | 35.0 → 36.1 |
| realworld / phone_thigh | 45.3 → 46.7 | 39.2 → 39.2 | 39.3 → 38.7 | 31.2 → 29.8 | 28.2 → 30.9 | 23.0 → 22.0 | 17.0 → 17.9 | 35.0 → 45.3 |
| realworld / phone_waist | 48.6 → 54.9 | 60.1 → 56.5 | 60.3 → 58.5 | 29.6 → 28.9 | 31.3 → 35.1 | 26.7 → 30.9 | 10.7 → 11.1 | 45.2 → 48.5 |
| shoaib / phone_belt | 73.7 → 81.0 | 74.0 → 79.4 | 74.8 → 80.0 | 48.3 → 50.8 | 42.9 → 40.0 | 15.2 → 16.1 | 18.9 → 21.9 | 42.0 → 46.2 |
| shoaib / phone_left_pocket | 59.9 → 65.9 | 72.3 → 75.4 | 72.7 → 75.6 | 36.4 → 38.0 | 35.1 → 31.6 | 29.6 → 29.1 | 14.6 → 21.6 | 30.5 → 21.9 |
| shoaib / phone_right_pocket | 51.6 → 52.8 | 47.6 → 54.9 | 47.6 → 54.9 | 34.0 → 31.7 | 29.5 → 29.9 | 31.2 → 24.6 | 18.9 → 19.4 | 5.9 → 17.4 |
| shoaib / watch_wrist_proxy | 70.3 → 62.2 | 58.5 → 59.1 | 58.3 → 59.1 | 43.6 → 43.9 | 53.5 → 53.5 | 13.8 → 23.0 | 27.9 → 28.3 | 48.5 → 41.3 |
| usc_had / phone_hip | 37.4 → 38.0 | 37.0 → 38.6 | 37.3 → 38.6 | 24.4 → 22.8 | 23.7 → 24.7 | 18.0 → 13.9 | 7.1 → 7.7 | 34.0 → 34.5 |
| ut_complex / watch_wrist | 43.5 → 42.8 | 39.3 → 30.7 | 41.6 → 30.3 | 27.6 → 29.9 | 26.2 → 26.7 | 9.8 → 9.6 | 10.8 → 15.8 | 31.6 → 30.9 |
...
| halo:rung1-trained-last | 31.77 | 0.86 | 0.48 | 0.76 | 0.00 |
| halo:rung1-trained-last-T30 | 30.00 | 0.86 | 0.48 | 0.76 | 0.00 |
