# Fresh HALO sealed evaluation: residual classifier

Run date: 2026-09-18

Sealed aggregate evaluation of the HALO encoder trained end to end with the learned residual support classifier (three readouts retained: `halo-classifier`, its base `halo-classifier-residual-off`, and cosine `1nn`), under
...
All 39 protocol cells completed in 22.7 minutes: 1572 scored rows,
18 explicit `n/a` rows, no failed rows. Every cell shared with
