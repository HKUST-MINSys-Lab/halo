...
def test_available_units_preserves_order_and_never_mutates_corpus(relation):
    import copy
    from training.support_classifier.sampling import _available_units, _draw_support
...
def test_draw_batch_never_returns_a_silently_short_batch(monkeypatch):
    ...
    monkeypatch.setattr("training.support_classifier.sampling.draw_episode", mostly_unusable)
...
def test_execution_derivation_matches_the_evaluation_loader():
    ...
    from training.support_classifier.sampling import _execution_ids
