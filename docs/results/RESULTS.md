...
Bold identifies the strongest score in each metric column. The prior single-scale fixed-filterbank
35k end-to-end control is retired from the promoted table: it is not matched to the retained
multiresolution and multispan frontends. The replacement controls are direct 35k end-to-end
neighbors runs for those two retained frontends; their cells remain absent until their checkpoints
are evaluated with these manifests.
