...
For reproduction only (Future-JEPA pretraining is retired): Future-JEPA's physical decoder deliberately uses a separate, frozen filterbank with polarization
