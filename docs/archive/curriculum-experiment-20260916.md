...
> Archived on 2026-09-24. This is the record of the 2026-09-16 curriculum experiment (Stages A and
> B) run while the evidence-aware v2 head (T3) was the experimental classifier; its "current
> classifier objective" section describes T3, which is a recorded negative result. The curriculum
> v4 actually trains with is the living contract [`../contracts/curriculum.md`](../contracts/curriculum.md).
