...
> **Superseded 2026-09-22.** This is the classifier-era thesis, whose research questions were about
> a learned classifier versus a nearest-neighbour control. The live thesis is
> [`docs/overview/thesis.md`](../overview/thesis.md); the decision record is
> [the 2026-09-22 journal entry](../journal/2026-09-22-three-regimes-and-unsupervised-adaptation-decisions.md). Kept for reproducibility only.
